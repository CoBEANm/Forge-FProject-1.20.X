...
public class ModCreativeModTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, FProject.MOD_ID);

    public static final RegistryObject<CreativeModeTab> MATERIALS =
            CREATIVE_MODE_TABS.register("materials_tab", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.SRAWBERRY.get());
