...
import net.bork.fproject.item.custom.FuelItem;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, FProject.MOD_ID);
    ...
    public static final RegistryObject<Item> SRAWBERRY = ITEMS.register("strawberry",
